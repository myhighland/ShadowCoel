...
let ShadowCoelZoneId = CKRecordZoneID(zoneName: "ShadowCoelCloud", ownerName: CKOwnerDefaultName)
let ShadowCoelDB = CKContainer.default().privateCloudDatabase
let ShadowCoelSubscriptionId = "allSubscription"
...
extension Proxy: CloudKitRecord {
    ...
    public var recordId: CKRecordID {
        return CKRecordID(recordName: uuid, zoneID: ShadowCoelZoneId)
    }
